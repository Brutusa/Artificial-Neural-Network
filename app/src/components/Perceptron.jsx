...
const Perceptron = () => {
    ...
    async function setX1(event) {
        ...
        await api.post("/input/x1/" + x1)
        console.log(x1);
    }

    async function getX1() {
        await api.get("/input/x1")
    }
    ...
    async function setX2(event) {
        ...
        await api.post("/input/x2/" + x2)
        console.log(x2);
    }

    async function getX2() {
        await api.get("/input/x2")
        console.log(x2);
    }
    ...
    async function setX3(event) {
        ...
        await api.post("/input/x3/" + x3)
        console.log(x3);
    }

    async function getX3() {
        await api.get("/input/x3")
        console.log(x3);
    }
    ...
    async function setX4(event) {
        ...
        await api.post("/input/x4/" + x4)
        console.log(x4);
    }

    async function getX4() {
        await api.get("/input/x4")
        console.log(x4);
    }

    //saves values from inputs
    async function inputPerceptron() {
        await api.post("/input-perceptron").then(function (response) {
        })
    }
    ...
    async function trainPerceptron() {
        await api.get("/train-perceptron").then(function (response) {
